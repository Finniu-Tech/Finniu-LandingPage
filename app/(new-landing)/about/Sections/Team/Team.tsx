import Card from "@/app/(new-landing)/about/Sections/Team/components/Card"
import PERSONS from "@/app/(new-landing)/about/Sections/Team/helper/persons"
...
const Team = () => {
  return (
    <section className="pb-10 md:pb-40 px-8 md:px-0 w-full bg-whitePrimary text-black flex flex-col justify-center items-center gap-10 md:gap-20">
      ...
      <ButtonLink href="/about/team" text="Ver todo el equipo" className="text-white py-4 px-6 rounded-full bg-purplePrincipal border-solid border-[1px] border-purplePrincipal hover:bg-white hover:text-purplePrincipal hover:border-solid hover:border-[1px] hover:border-purplePrincipal transition duration-150 ease"/>
    </section>
  )
}
