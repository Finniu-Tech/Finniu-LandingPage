import Card from "@/app/(new-landing)/about/Sections/Private/components/Card"
import OBJECTIVES from "@/app/(new-landing)/about/Sections/Private/helper/objectives"
