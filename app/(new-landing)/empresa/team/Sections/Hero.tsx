  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center gap-4">
        <h2 className="text-center text-5xl md:text-8xl leading-tight">Equipo</h2>
        <p className="text-xl text-center sm:text-2xl w-full sm:w-[60rem] text-gray-400">
          Nuestro equipo está compuesto por 10 profesionales apasionados por el mundo fintech, wealthtech e inversiones, con experiencia en diseño, tecnología, desarrollo de negocios y estrategia digital.
        </p>
      </div>
      <div className="mt-20">
        <Bounce />
