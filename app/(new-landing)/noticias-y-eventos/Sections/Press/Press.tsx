import NOTES from "@/app/(new-landing)/noticias-y-eventos/Sections/Press/helpers/notes"
import CardNote from "@/app/(new-landing)/noticias-y-eventos/Sections/Press/components/CardNote"
    ...
    <section className="py-10 pb-24 md:py-40 px-8 md:px-40 xxxl:px-80 w-full flex items-start justify-center bg-whitePrimary text-black">
      ...
      >
        <div className="flex flex-col text-center md:text-start items-center md:items-start gap-2 md:gap-4 mb-4 md:mb-10">
          <h3 className="text-4xl md:text-6xl">Notas de prensa</h3>
          <div className="md:hidden absolute w-[12rem] md:w-48 bottom-0 md:top-0 md:right-9">
