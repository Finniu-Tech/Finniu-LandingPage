import COMPANIESNECSAC from "@/app/(new-landing)/portafolio-finniu/Sections/Portfolio/helper/companiesNecsac"
    ...
    >
      ...
      <div className="carousel h-auto mb-4 md:mb-0">
        <div className="carousel-body px-0 py-2 h-full">
          {COMPANIESNECSAC.map((company, index) => (
