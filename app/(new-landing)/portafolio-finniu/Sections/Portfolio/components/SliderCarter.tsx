import COMPANIESCARTER from "@/app/(new-landing)/portafolio-finniu/Sections/Portfolio/helper/companiesCarter"
...
const SliderCarter = ({arrowLeft, arrowRight, cardPortfolio}:Props) => {
  return (
    <div
      id="multi-slide"
    ...
    >
      ...
      <div className="carousel h-auto mb-4 md:mb-0">
        <div className="carousel-body px-0 py-2 h-full">
          {COMPANIESCARTER.map((company, index) => (
