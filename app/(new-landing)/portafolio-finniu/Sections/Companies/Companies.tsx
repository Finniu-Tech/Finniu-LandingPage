import COMPANIES from "@/app/(new-landing)/portafolio-finniu/Sections/Companies/helper/companies"
import CardCompany from "@/app/(new-landing)/portafolio-finniu/Sections/Companies/components/CardCompany"
