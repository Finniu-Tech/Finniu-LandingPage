import CardInvest  from "@/app/(new-landing)/invest/Sections/Invest/components/CardInvest"
import INVESTS from "@/app/(new-landing)/invest/Sections/Invest/helpers/invest"
