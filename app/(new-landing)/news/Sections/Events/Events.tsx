import EVENTS from "@/app/(new-landing)/news/Sections/Events/helpers/events"
import CardEvent from "@/app/(new-landing)/news/Sections/Events/components/CardEvent"
...
const Events = () => {
  return (
    <section className="py-10 pb-24 md:py-40 px-8 md:px-40 xxxl:px-80 w-full flex items-start justify-center bg-whitePrimary text-black">
      <div
        id="multi-slide"
        data-carousel='{ "loadingClasses": "opacity-0", "isInfiniteLoop": true, "isDraggable": true, "isAutoPlay": true, "speed": 2000, "slidesQty": { "xs": 1, "lg": 1 } }'
