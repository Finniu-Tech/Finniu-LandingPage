...
import Mackbook from "@/app/(new-landing)/Home/Ready/images/Macbook.webp"
...
const Ready = () => {
  return (
    ...
    //   <div className="flex flex-col pr-8 md:px-0 justify-center items-center md:items-start gap-4 md:gap-8">
    //     <h3 className="font-bold text-base">LISTOS PARA CRECER CONTIGO</h3>
    //     <h3 className="w-full text-center md:text-start md:w-[35rem] text-4xl md:text-6xl leading-none md:leading-tight">
