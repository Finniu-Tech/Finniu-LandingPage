      ...
      >
        <div className="flex flex-col items-start gap-4 mb-6">
          ...
          <div className="absolute w-48 top-5 right-9">
            <button className="carousel-prev size-20 bg-purplePrincipal rounded-full text-white border-solid border-[1px] border-purplePrincipal hover:bg-white hover:text-purplePrincipal hover:border-solid hover:border-[1px] hover:border-purplePrincipal transition duration-150 ease ">
              <ArrowLeft />
            </button>
            <button className="carousel-next size-20 bg-purplePrincipal rounded-full text-white border-solid border-[1px] border-purplePrincipal hover:bg-white hover:text-purplePrincipal hover:border-solid hover:border-[1px] hover:border-purplePrincipal transition duration-150 ease ">
              <ArrowRight />
            </button>
          </div>
        </div>
