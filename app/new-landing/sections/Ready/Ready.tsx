...
const Ready = () => {
  return (
    <section className="py-40 bg-white text-black flex justify-center items-center gap-12">
      <div className="flex flex-col justify-center items-start gap-8">
        ...
        <ButtonLink href="#" text="Empieza ahora" className="mt-4 text-white py-4 px-6 rounded-full bg-purplePrincipal" />
      </div>
