  ...
  return (
    <section className="py-10 md:py-40 px-8 pr-0 md:pl-80 w-full bg-whitePrimary text-black flex flex-col md:flex-row justify-between items-center">
      <div className="flex flex-col pr-8 md:px-0 justify-center items-center md:items-start gap-2 md:gap-8">
        ...
        <h3 className="w-full text-center md:text-start md:w-[30rem] text-5xl md:text-6xl leading-none md:leading-tight">Sin requisitos ocultos y sin comisiones</h3>
        <h3 className="w-full text-center md:text-start md:w-[30rem]">Regístrate de cualquier celular o computador y obtén más ganancias con tus ahorros. Genera un ingreso extra al mes</h3>
