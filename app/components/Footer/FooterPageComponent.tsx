...
const Footer = () => {
  return (
    <footer className="bg-gray-50 border-t      border-gray-200 py-8 w-full">
      <div className="container mx-auto flex flex-col xl:flex-row justify-between items-start px-12 xl:px-48">
        <div className="flex flex-col xl:flex-row w-full leading-9">
          ...
          <div className="flex-1 leading-9  pl-0 xl:pl-4">
        ...
        <div className="flex flex-col xl:flex-row w-full leading-9 mt-6 md:mt-0">
          <div className="flex-1 mb-6 md:mb-0 md:pr-4">
      ...
      <div className="mt-8 text-center text-darkBlueColor text-[11px]   xl:text-sm">
