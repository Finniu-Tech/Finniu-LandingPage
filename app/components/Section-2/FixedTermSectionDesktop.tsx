  ...
  return (
    <div className="flex relative container-section">
      <div className="text-left w-[561px] z-10 flex flex-col justify-center mb-24">
        <p
          className={`mb-4 leading-tight font-bold  transition-all duration-300  cursor-pointer ${showComponentFixedTermSelectedState
            ? "text-textSupport text-[40px]"
        ...
        <p
          className={`font-bold mb-4 leading-tight cursor-pointer ${showComponentFixedTermSelectedState
            ? "text-grayColorText text-[36px]"
            : "text-textSupport text-[45px]"
            }`}
          onClick={handleTextClick}
        >
      ...
      <div
        className={` image-container  ${showComponentFixedTermSelectedState ? "" : "hidden"
          }`}
      >
        <Image
          src={CellphoneImage}
